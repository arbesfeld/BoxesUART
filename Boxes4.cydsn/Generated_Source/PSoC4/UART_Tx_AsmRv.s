...
;==============================================================================
    ...
    IMPORT UART_Tx_pinNumber
    IMPORT UART_Tx_pinPortNumber
    IMPORT UART_Tx_pinDrAdress
...
; void UART_Tx_PutChar(uint8 txDataByte)
    ALIGN 8
UART_Tx_PutChar FUNCTION
    EXPORT UART_Tx_PutChar
...
PIN_NUMBER DCD UART_Tx_pinNumber
PORT_NUMBER DCD UART_Tx_pinPortNumber
PORT_DR_ADDRESS DCD UART_Tx_pinDrAdress
