...
.global UART_Tx_pinNumber
.global UART_Tx_pinPortNumber
...
.global UART_Tx_PutChar
.func UART_Tx_PutChar, UART_Tx_PutChar
.type UART_Tx_PutChar, %function
.thumb_func
UART_Tx_PutChar:
...
bitTxLoop:
    ...
    .align 5
PIN_NUMBER:
    .word UART_Tx_pinNumber
PORT_NUMBER:
    .word UART_Tx_pinPortNumber
PORT_DR_ADDRESS:
    .word UART_Tx_pinDrAdress
FREQ:
    .word cydelayFreqHz
BAUD_RATE:
    .word 38400
