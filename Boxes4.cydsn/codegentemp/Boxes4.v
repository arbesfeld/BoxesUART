// ======================================================================
// Boxes4.v generated from TopDesign.cysch
// 04/25/2015 at 22:24
...
// SCB_P4_v2_0(ApplySbClockParam=false, BitWidthReplacementStringRx=uint8, BitWidthReplacementStringTx=uint8, BufNum=1, Clock_CheckTolerance=false, Clock_desired_freq=24000, Clock_desired_freq_unit=3, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Cond=#, DBGW_SCB_IP_V0=true, DBGW_SCB_IP_V1=false, DBGW_SCB_IP_V2=false, EndCond=#endif, EzI2cBitWidthReplacementString=uint16, EzI2cBusVoltage=3.3, EzI2cByteModeEnable=false, EzI2cClkFreqDes=1550, EzI2cClockFromTerm=false, EzI2cClockStretching=true, EzI2cDataRate=100, EzI2cIsPrimarySlaveAddressHex=true, EzI2cIsSecondarySlaveAddressHex=true, EzI2cMedianFilterEnable=true, EzI2cNumberOfAddresses=0, EzI2cOvsFactor=16, EzI2cPrimarySlaveAddress=8, EzI2cSecondarySlaveAddress=9, EzI2cSlaveAddressMask=254, EzI2cSlewRate=0, EzI2cSubAddressSize=0, EzI2cWakeEnable=false, I2cAcceptAddress=false, I2cBusVoltage=3.3, I2cBusVoltageLevel=, I2cByteModeEnable=false, I2cClkFreqDes=1550, I2cClockFromTerm=false, I2cDataRate=100, I2cExternIntrHandler=false, I2cIsSlaveAddressHex=true, I2cIsSlaveAddressMaskHex=true, I2cManualOversampleControl=true, I2cMedianFilterEnable=true, I2cMode=1, I2cOvsFactor=16, I2cOvsFactorHigh=8, I2cOvsFactorLow=8, I2cSlaveAddress=8, I2cSlaveAddressMask=254, I2cSlewRate=0, I2cSlewRateSettings=0, I2cWakeEnable=false, PinName0Unconfig=spi_mosi_i2c_scl_uart_rx, PinName0UnconfigWake=spi_mosi_i2c_scl_uart_rx_wake, PinName1Unconfig=spi_miso_i2c_sda_uart_tx, PinName2Unconfig=spi_sclk, PinName3Unconfig=spi_ss0, RemoveI2cPins=true, RemoveMisoSdaTx=true, RemoveMosiSclRx=true, RemoveMosiSclRxWake=true, RemoveScbClk=false, RemoveScbIrq=false, RemoveSpiMasterPins=true, RemoveSpiMasterSs0Pin=true, RemoveSpiMasterSs1Pin=true, RemoveSpiMasterSs2Pin=true, RemoveSpiMasterSs3Pin=true, RemoveSpiSclk=true, RemoveSpiSlavePins=true, RemoveSpiSs0=true, RemoveSpiSs1=true, RemoveSpiSs2=true, RemoveSpiSs3=true, RemoveUartCtsPin=true, RemoveUartRtsPin=true, RemoveUartRxPin=false, RemoveUartRxTxPin=true, RemoveUartRxWake=true, RemoveUartRxWakeupIrq=true, RemoveUartTxPin=true, ScbClkFreqDes=460.8, ScbClkMinusTolerance=5, ScbClkPlusTolerance=5, ScbClockSelect=1, ScbClockTermEnable=false, ScbCustomIntrHandlerEnable=true, ScbInterruptTermEnable=false, ScbMisoSdaTxEnable=true, ScbMode=4, ScbModeHw=2, ScbMosiSclRxEnable=true, ScbRxWakeIrqEnable=false, ScbSclkEnable=false, ScbSs0Enable=false, ScbSs1Enable=false, ScbSs2Enable=false, ScbSs3Enable=false, SpiBitRate=1000, SpiBitsOrder=1, SpiByteModeEnable=false, SpiClkFreqDes=16000, SpiClockFromTerm=false, SpiFreeRunningSclk=false, SpiInterruptMode=0, SpiIntrMasterSpiDone=false, SpiIntrRxFull=false, SpiIntrRxNotEmpty=false, SpiIntrRxOverflow=false, SpiIntrRxTrigger=false, SpiIntrRxUnderflow=false, SpiIntrSlaveBusError=false, SpiIntrTxEmpty=false, SpiIntrTxNotFull=false, SpiIntrTxOverflow=false, SpiIntrTxTrigger=false, SpiIntrTxUnderflow=false, SpiLateMisoSampleEnable=false, SpiManualOversampleControl=true, SpiMedianFilterEnable=false, SpiMode=0, SpiNumberOfRxDataBits=8, SpiNumberOfSelectLines=1, SpiNumberOfTxDataBits=8, SpiOvsFactor=16, SpiRxBufferSize=8, SpiRxIntrMask=0, SpiRxTriggerLevel=7, SpiSclkMode=0, SpiSs0Polarity=0, SpiSs1Polarity=0, SpiSs2Polarity=0, SpiSs3Polarity=0, SpiSubMode=0, SpiTransferSeparation=1, SpiTxBufferSize=8, SpiTxIntrMask=0, SpiTxTriggerLevel=0, SpiWakeEnable=false, TermMode_clock=0, TermMode_interrupt=0, TermVisibility_clock=false, TermVisibility_interrupt=false, UartByteModeEnable=false, UartClkFreqDes=460.8, UartClockFromTerm=false, UartCtsEnable=false, UartCtsPolarity=0, UartDataRate=38400, UartDirection=1, UartDropOnFrameErr=false, UartDropOnParityErr=false, UartInterruptMode=1, UartIntrRxFrameErr=false, UartIntrRxFull=false, UartIntrRxNotEmpty=true, UartIntrRxOverflow=false, UartIntrRxParityErr=false, UartIntrRxTrigger=false, UartIntrRxUnderflow=false, UartIntrTxEmpty=false, UartIntrTxNotFull=false, UartIntrTxOverflow=false, UartIntrTxTrigger=false, UartIntrTxUartDone=false, UartIntrTxUartLostArb=false, UartIntrTxUartNack=false, UartIntrTxUnderflow=false, UartIrdaLowPower=false, UartIrdaPolarity=0, UartMedianFilterEnable=false, UartMpEnable=false, UartMpRxAcceptAddress=false, UartMpRxAddress=2, UartMpRxAddressMask=255, UartNumberOfDataBits=8, UartNumberOfStopBits=2, UartOvsFactor=12, UartParityType=2, UartRtsEnable=false, UartRtsPolarity=0, UartRtsTriggerLevel=4, UartRxBufferSize=8, UartRxEnable=true, UartRxIntrMask=4, UartRxTriggerLevel=7, UartSmCardRetryOnNack=false, UartSubMode=0, UartTxBufferSize=8, UartTxEnable=false, UartTxIntrMask=0, UartTxTriggerLevel=0, UartWakeEnable=false, CY_COMPONENT_NAME=SCB_P4_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Rx_Left, CY_INSTANCE_SHORT_NAME=Rx_Left, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.1 SP2, INSTANCE_NAME=Rx_Left, )
...
// UART_v2_40(Address1=0, Address2=0, BaudRate=38400, BreakBitsRX=13, BreakBitsTX=13, BreakDetect=false, CRCoutputsEn=false, Enable_RX=1, Enable_RXIntInterrupt=0, Enable_TX=0, Enable_TXIntInterrupt=0, EnableHWAddress=0, EnIntRXInterrupt=false, EnIntTXInterrupt=false, FlowControl=0, HalfDuplexEn=false, HwTXEnSignal=true, InternalClock=true, InternalClockToleranceMinus=3.93736842105263, InternalClockTolerancePlus=3.93736842105263, InternalClockUsed=1, InterruptOnAddDetect=0, InterruptOnAddressMatch=0, InterruptOnBreak=0, InterruptOnByteRcvd=1, InterruptOnOverrunError=0, InterruptOnParityError=0, InterruptOnStopError=0, InterruptOnTXComplete=false, InterruptOnTXFifoEmpty=false, InterruptOnTXFifoFull=false, InterruptOnTXFifoNotFull=false, IntOnAddressDetect=false, IntOnAddressMatch=false, IntOnBreak=false, IntOnByteRcvd=true, IntOnOverrunError=false, IntOnParityError=false, IntOnStopError=false, NumDataBits=8, NumStopBits=1, OverSamplingRate=8, ParityType=0, ParityTypeSw=false, RequiredClock=307200, RXAddressMode=0, RXBufferSize=4, RxBuffRegSizeReplacementString=uint8, RXEnable=true, TXBitClkGenDP=true, TXBufferSize=4, TxBuffRegSizeReplacementString=uint8, TXEnable=false, Use23Polling=true, CY_COMPONENT_NAME=UART_v2_40, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Rx_Back, CY_INSTANCE_SHORT_NAME=Rx_Back, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=40, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.1 SP2, INSTANCE_NAME=Rx_Back, )
module UART_v2_40_3 (
    rx_clk,
    rx_data,
    tx_clk,
...
module top ;
	...
	wire [2:0] tmpOE__RGBLed_net;
	wire [2:0] tmpFB_2__RGBLed_net;
	wire [2:0] tmpIO_2__RGBLed_net;
	wire [0:0] tmpINTERRUPT_0__RGBLed_net;
	electrical [0:0] tmpSIOVREF__RGBLed_net;
	...
	cy_psoc3_pins_v1_10
		...
		RGBLed
		 (.oe(tmpOE__RGBLed_net),
		  .y({3'b0}),
		  .fb({tmpFB_2__RGBLed_net[2:0]}),
		  .io({tmpIO_2__RGBLed_net[2:0]}),
		  .siovref(tmpSIOVREF__RGBLed_net),
		  .interrupt({tmpINTERRUPT_0__RGBLed_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RGBLed_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{3'b111} : {3'b111};

    UART_v2_40_0 Rx_Front (
        .cts_n(1'b0),
        .tx(Net_536),
        .rts_n(Net_537),
        .tx_en(Net_538),
        ...
        .reset(1'b0),
        .rx(Net_33),
        .tx_interrupt(Net_541),
        .rx_interrupt(Net_177),
        .tx_data(Net_542),
        .tx_clk(Net_543),
        .rx_data(Net_544),
        .rx_clk(Net_545));
    defparam Rx_Front.Address1 = 0;
    defparam Rx_Front.Address2 = 0;
    defparam Rx_Front.EnIntRXInterrupt = 0;
    defparam Rx_Front.EnIntTXInterrupt = 0;
    defparam Rx_Front.FlowControl = 0;
    defparam Rx_Front.HalfDuplexEn = 0;
    defparam Rx_Front.HwTXEnSignal = 1;
    defparam Rx_Front.NumDataBits = 8;
    defparam Rx_Front.NumStopBits = 1;
    defparam Rx_Front.ParityType = 0;
    defparam Rx_Front.RXEnable = 1;
    defparam Rx_Front.TXEnable = 0;

    SCB_P4_v2_0_1 Rx_Right (
        .interrupt(Net_561),
        .clock(1'b0));
    ...
    assign Net_158 = Net_394 | Net_393 | Net_533 | Net_395;


    assign Net_33 = Net_373 | Net_364 | Net_372 | Net_374;

    SCB_P4_v2_0_2 Rx_Left (
        .interrupt(Net_563),
        .clock(1'b0));

	wire [3:0] tmpOE__Rx_Front_Pins_net;
	wire [3:0] tmpIO_3__Rx_Front_Pins_net;
	wire [0:0] tmpINTERRUPT_0__Rx_Front_Pins_net;
	electrical [0:0] tmpSIOVREF__Rx_Front_Pins_net;
	...
	cy_psoc3_pins_v1_10
		...
		Rx_Front_Pins
		 (.oe(tmpOE__Rx_Front_Pins_net),
		  .y({4'b0}),
		  .fb({Net_374, Net_373, Net_364, Net_372}),
		  .io({tmpIO_3__Rx_Front_Pins_net[3:0]}),
		  .siovref(tmpSIOVREF__Rx_Front_Pins_net),
		  .interrupt({tmpINTERRUPT_0__Rx_Front_Pins_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Rx_Front_Pins_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{4'b1111} : {4'b1111};

    UART_v2_40_3 Rx_Back (
        .cts_n(1'b0),
        .tx(Net_511),
        .rts_n(Net_512),
        .tx_en(Net_513),
        ...
        .reset(1'b0),
        .rx(Net_158),
        .tx_interrupt(Net_516),
        .rx_interrupt(Net_179),
        .tx_data(Net_517),
        .tx_clk(Net_518),
        .rx_data(Net_519),
        .rx_clk(Net_520));
    defparam Rx_Back.Address1 = 0;
    defparam Rx_Back.Address2 = 0;
    defparam Rx_Back.EnIntRXInterrupt = 0;
    defparam Rx_Back.EnIntTXInterrupt = 0;
    defparam Rx_Back.FlowControl = 0;
    defparam Rx_Back.HalfDuplexEn = 0;
    defparam Rx_Back.HwTXEnSignal = 1;
    defparam Rx_Back.NumDataBits = 8;
    defparam Rx_Back.NumStopBits = 1;
    defparam Rx_Back.ParityType = 0;
    defparam Rx_Back.RXEnable = 1;
    defparam Rx_Back.TXEnable = 0;

	wire [3:0] tmpOE__Rx_Back_Pins_net;
	wire [3:0] tmpIO_3__Rx_Back_Pins_net;
	wire [0:0] tmpINTERRUPT_0__Rx_Back_Pins_net;
	electrical [0:0] tmpSIOVREF__Rx_Back_Pins_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("0b40146a-1b01-4b78-9629-e69da0054771"),
		  ...
		  .input_buffer_sel(8'b00_00_00_00))
		Rx_Back_Pins
		 (.oe(tmpOE__Rx_Back_Pins_net),
		  .y({4'b0}),
		  .fb({Net_395, Net_394, Net_393, Net_533}),
		  .io({tmpIO_3__Rx_Back_Pins_net[3:0]}),
		  .siovref(tmpSIOVREF__Rx_Back_Pins_net),
		  .interrupt({tmpINTERRUPT_0__Rx_Back_Pins_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Rx_Back_Pins_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{4'b1111} : {4'b1111};
