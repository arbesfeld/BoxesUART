    ...
    while(UART_4_GetRxBufferSize() > 0u)
    {
        ...
        *count  =(*count) + tempCount;
        ...
        if(*count < size)
        {
            ...
            *  If not wait for additional time UART_4_WAIT_EOP_DELAY.
            */
            if(pData[dataIndexCntr - 1u] != UART_4_PACKET_EOP)
            {
                CyDelay(UART_4_WAIT_EOP_DELAY);
            }
        }
