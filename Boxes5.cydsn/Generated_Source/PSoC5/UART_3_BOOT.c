    ...
    while(UART_3_GetRxBufferSize() > 0u)
    {
        ...
        *count  =(*count) + tempCount;
        ...
        if(*count < size)
        {
            ...
            *  If not wait for additional time UART_3_WAIT_EOP_DELAY.
            */
            if(pData[dataIndexCntr - 1u] != UART_3_PACKET_EOP)
            {
                CyDelay(UART_3_WAIT_EOP_DELAY);
            }
        }
